    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="row">
                    <div class="col-md-6">
                        <a href="/product/shop" class="f-product-2" style="background-image: url(images/i2.jpg);">
                            <div class="desc">
                                <h2> <br>Váy <br> Mới</h2>
                            </div>
                        </a>
                    ...
                    <div class="col-md-6">
                        <a href="/product/shop" class="f-product-2" style="background-image: url(images/i3.jpg);">
                            <div class="desc">
                    ...
                    <div class="col-md-12">
                        <a href="/product/shop" class="f-product-2" style="background-image: url(images/i4.jpg);">
                            <div class="desc">
